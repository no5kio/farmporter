...
<nav class="navbar navbar-default sidebar" role="navigation">
  ...
  <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
    <ul class="nav navbar-nav">
      ...
      <li class="menu">
        <a href="/myapp/rg/farm-sites" class="menu" data-toggle="menu">귀농 관련 사이트 <span></span><span style="font-size:16px;" class="pull-right hidden-xs glyphicon glyphicon-user"></span></a>
      </li>
    </ul>
  </div>
</div>
